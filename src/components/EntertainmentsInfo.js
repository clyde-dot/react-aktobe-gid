                        ...
                        <div className="my-flip-side my-flip-back my-flip-back-1">
                            <div className="my-flip-back-inner">
                                ...
                                <div className="my-flip-back-text">
                                    ...
                                    <li><a className='headerSubtitle-map-link' target={"_blank"}  href={address}>{t("hotel_card_detail_info_show_map_button")}</a></li>
                                    <li>{phone}</li>
                                    </ul>
                                </div>
                                <div className="my-flip-btn-box">
                                    <Link onClick={()=>localStorage.setItem('detailCard', JSON.stringify(value))} to="/detailsentertainment" className="my-flip-btn">
                                        {t("entertainments_card_detail_info_button")}
                                    </Link>
                                </div>
                            </div>
                        </div>
